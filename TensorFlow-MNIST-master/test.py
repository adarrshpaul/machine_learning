...
mnist.predict(script_dir + '/imgs/digit-4.jpg')
mnist.predict(script_dir + '/imgs/digit-2.jpg')
mnist.predict(script_dir + '/imgs/digit-5.jpg')
mnist.predict(script_dir + '/imgs/digit-1.jpg')
mnist.predict(script_dir + '/imgs/digit-3.jpg')
